...
`.م5` » المعرفه اوامر الزخرفه الاسماء
'''
sec1 = '''
`-- -- -- -- -- -- -- -- --`
**⟨ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗗𝗧𝗛𝗢𝗡 ⟩
...
محتويات الامر : [`.قمور`][`.حلويات`][`.قلوب`][`.العد التنازلي`][`.قمر`][`.مصه`][`.سيرفر`][`.مصدوم`][`.صدمه]
...
⟨ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗕𝗗𝗧𝗛𝗢𝗡 ⟩
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
- ارسـل `.زخرف` + اسمـك بالانكلـش

زخرفه الاسماء العربيه غير متوفر حاليا قريبا سيتم تفعيل زخرفه عربي"""
