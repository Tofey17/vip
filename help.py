...
‏𓊇 `.م1` ║ اعدادات السورس 𓊆
‏𓊇 `.م2` ║ لمعرفة اوامر صيد اليوزرات 𓊆
‏𓊇 `.م3` ║ لمعرفة اوامر تجميع نقاط بوتات التمويل 𓊆
‏𓊇 `.م4` ║  لمعرفة اوامر السورس الاضافية 𓊆

🍩 ≪ 🍦 ≪ ⛓ ≪ 🎀 ≪ 🧸 ≪ 🛍 ≪

قــنـــاة الــســورس ┋ @BDthon
مــطـور الــــسـورس┋ @B_8_K
...
`.تجميع ارشقلي` : يقوم بتجميع نقاط بوت تمويل ارشقلي

`.تجميع العراق` : يقوم بتجميع نقاط بوت تمويل العراق

`تجميع محمديون`:  يقوم بتجميع نقاط بوت تموسل محمديون

╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
"""
sec4 = """
الاوامر الاضافية | 𝗕𝗗𝗧𝗛𝗢𝗡
...
مثال | [`.مؤقت 3 5 مرحبأ بك في سورس بدثون` ]
...
مثال | `.للخاص مرحبا بك في سورس بدثون `
...
محتويات الامر : [`.قمور`][`.حلويات`][`.قلوب`][`.العد التنازلي`][`.قمر`][`.مصه`][`.سيرفر`]
